...
(() => {
  ...
  function buildTestRunReportHtml(report) {
    ...
    return `<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>${escHtml(report.name)} — Playwright Pilot</title>
<style>
...
<div class="footer">
  ...
  ${escHtml(siteName)} — ${flowLabel} Flow Report &middot; Generated by <strong>Playwright Pilot</strong>
</div>
</body></html>`;
  }
...
<div class="footer">
  <img src="${escHtml(faviconSrc)}" width="16" height="16" style="vertical-align:middle;margin-right:4px;border-radius:3px"/>
  ${escHtml(siteName)} — Site Audit Report &middot; Generated by <strong>Playwright Pilot</strong>
</div>
</body></html>`;
  }
})();
